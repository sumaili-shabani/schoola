...
export default function Pays() {
    ...
    const loadDatas = async () => {
        setLoading(true);
        try {
            const res = await fetchItems<Entity>("/fetch_pays", {
                page: currentPage,
                limit,
                query: search,
            });
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        const res = await saveItem("/insert_pays", payload);
    ...
    const handleEdit = async (id: number) => {
        setLoading(true);
        const res = await fetchSigleItem<Entity>("/fetch_single_pays", id);
    ...
    const handleDelete = async (id: number) => {
        ...
        if (!confirm) return;
        const res = await removeItem("/delete_pays", id);
        showSuccessMessage(res);
        loadDatas();
    };
