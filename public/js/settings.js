    ...
    n.n = function (t) {
        ...
        function () {
            ...
            const c = () => {
                ...
                h = (t, e) => {
                    if ("theme" === t) {
                        // 🔹 Chercher ou créer la balise .js-stylesheet
                        let link = document.querySelector(".js-stylesheet");
                        if (!link) {
                            link = document.createElement("link");
                            link.rel = "stylesheet";
                            link.className = "js-stylesheet";
                            link.href = "css/light.css"; // thème par défaut
                            document.head.appendChild(link);
                        }

                        // 🔹 Déterminer le thème à appliquer
                        const themeFile = e === "dark" ? "dark" : "light";
                        link.setAttribute("href", "css/" + themeFile + ".css");

                        // On supprime le rechargement forcé de page
                        a = themeFile;
                    }

                    // 🔹 Vérifier que document.body est bien présent
                    if (document.body) {
                        document.body.dataset[t] = e;
                    }
                },
